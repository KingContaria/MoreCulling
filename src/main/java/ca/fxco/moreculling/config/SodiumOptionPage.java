...
public class SodiumOptionPage {
    ...
    public static OptionPage moreCullingPage() {
        ...
        MoreCullingSodiumOptionImpl<MoreCullingConfig, Boolean> cloudCulling = MoreCullingSodiumOptionImpl.createBuilder(boolean.class, morecullingOpts)
                .setName(TextHelper.translatable("moreculling.config.option.cloudCulling"))
        ...
        MoreCullingSodiumOptionImpl<MoreCullingConfig, Boolean> signTextCulling = MoreCullingSodiumOptionImpl.createBuilder(boolean.class, morecullingOpts)
                .setName(TextHelper.translatable("moreculling.config.option.signTextCulling"))
        ...
        /*MoreCullingSodiumOptionImpl<MoreCullingConfig, Boolean> entityModelCulling = MoreCullingSodiumOptionImpl.createBuilder(boolean.class, morecullingOpts)
                .setName(TextHelper.translatable("moreculling.config.option.entityModelCulling"))
        ...
        MoreCullingSodiumOptionImpl<MoreCullingConfig, Boolean> rainCulling = MoreCullingSodiumOptionImpl.createBuilder(boolean.class, morecullingOpts)
                .setName(TextHelper.translatable("moreculling.config.option.rainCulling"))
        ...
        MoreCullingSodiumOptionImpl<MoreCullingConfig, Integer> leavesCullingAmount = MoreCullingSodiumOptionImpl.createBuilder(int.class, morecullingOpts)
                .setName(TextHelper.translatable("moreculling.config.option.leavesCullingAmount"))
                .setTooltip(TextHelper.translatable("moreculling.config.option.leavesCullingAmount.tooltip"))
                .setControl(option -> new IntSliderControl(option, 1, 4, 1, TextHelper.literal("%d")))
        ...
        MoreCullingSodiumOptionImpl<MoreCullingConfig, LeavesCullingMode> leavesCullingMode = MoreCullingSodiumOptionImpl.createBuilder(LeavesCullingMode.class, morecullingOpts)
                .setName(TextHelper.translatable("moreculling.config.option.leavesCulling"))
        ...
        MoreCullingSodiumOptionImpl<MoreCullingConfig, Boolean> includeMangroveRoots = MoreCullingSodiumOptionImpl.createBuilder(boolean.class, morecullingOpts)
                .setName(TextHelper.translatable("moreculling.config.option.includeMangroveRoots"))
        ...
        MoreCullingSodiumOptionImpl<MoreCullingConfig, Boolean> powderSnowCulling = MoreCullingSodiumOptionImpl.createBuilder(boolean.class, morecullingOpts)
                .setName(TextHelper.translatable("moreculling.config.option.powderSnowCulling"))
        ...
        MoreCullingSodiumOptionImpl<MoreCullingConfig, Boolean> blockStateCulling = MoreCullingSodiumOptionImpl.createBuilder(boolean.class, morecullingOpts)
                .setName(TextHelper.translatable("moreculling.config.option.blockStateCulling"))
        ...
        MoreCullingSodiumOptionImpl<MoreCullingConfig, Boolean> itemFrameMapCullingOption = MoreCullingSodiumOptionImpl.createBuilder(boolean.class, morecullingOpts)
                .setName(TextHelper.translatable("moreculling.config.option.itemFrameMapCulling"))
        ...
        MoreCullingSodiumOptionImpl<MoreCullingConfig, Integer> itemFrameLODRange = MoreCullingSodiumOptionImpl.createBuilder(int.class, morecullingOpts)
                .setName(TextHelper.translatable("moreculling.config.option.itemFrameLODRange"))
                .setTooltip(TextHelper.translatable("moreculling.config.option.itemFrameLODRange.tooltip"))
                .setControl(option -> new IntSliderControl(option, 48, 768, 1, TextHelper.literal("%d")))
        ...
        MoreCullingSodiumOptionImpl<MoreCullingConfig, Boolean> itemFrameLODOption = MoreCullingSodiumOptionImpl.createBuilder(boolean.class, morecullingOpts)
                .setName(TextHelper.translatable("moreculling.config.option.itemFrameLOD"))
        ...
        MoreCullingSodiumOptionImpl<MoreCullingConfig, Float> itemFrame3FaceRange = MoreCullingSodiumOptionImpl.createBuilder(float.class, morecullingOpts)
                .setName(TextHelper.translatable("moreculling.config.option.itemFrame3FaceCullingRange"))
                .setTooltip(TextHelper.translatable("moreculling.config.option.itemFrame3FaceCullingRange.tooltip"))
                .setControl(option -> new FloatSliderControl(option, 0.0F, 48.0F, 0.5F, TextHelper.literal("%2.2f")))
        ...
        MoreCullingSodiumOptionImpl<MoreCullingConfig, Boolean> itemFrame3FaceOption = MoreCullingSodiumOptionImpl.createBuilder(boolean.class, morecullingOpts)
                .setName(TextHelper.translatable("moreculling.config.option.itemFrame3FaceCulling"))
        ...
        groups.add(OptionGroup.createBuilder()
                .add(MoreCullingSodiumOptionImpl.createBuilder(boolean.class, morecullingOpts)
                        .setName(TextHelper.translatable("moreculling.config.option.customItemFrameRenderer"))
        ...
        return new OptionPage(TextHelper.translatable("moreculling.title"), ImmutableList.copyOf(groups));
    }
            ...
            for (ConfigOption option : groupedOptions.get(group)) {
                ...
                if (option instanceof ConfigBooleanOption) {
                    ...
                    optionBuilder = MoreCullingSodiumOptionImpl.createBuilder(float.class, morecullingOpts)
                            .setControl(opt -> new FloatSliderControl(opt, floatOption.getMin(), floatOption.getMax(), floatOption.getInterval(), TextHelper.literal(floatOption.getStringFormat())))
                    ...
                    optionBuilder = MoreCullingSodiumOptionImpl.createBuilder(int.class, morecullingOpts)
                            .setControl(opt -> new IntSliderControl(opt, intOption.getMin(), intOption.getMax(), intOption.getInterval(), TextHelper.literal(intOption.getStringFormat())))
                ...
                if (optionBuilder != null) {
                    optionBuilder.setName(TextHelper.translatable(option.getTranslationKey()))
                            .setTooltip(TextHelper.translatable(option.getTranslationKey() + ".tooltip"))
